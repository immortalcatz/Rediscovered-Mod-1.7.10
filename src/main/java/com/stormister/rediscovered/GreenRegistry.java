 ...
 *
 */
public class GreenRegistry
{
    private static final GreenRegistry INSTANCE = new GreenRegistry();
    ...
    public interface IVillageTradeHandler
    {
         ...
         * @param recipeList
         */
        void manipulateTradesForVillager(EntityGreenVillager villager, MerchantRecipeList recipeList, Random random);
    }

    public static GreenRegistry instance()
    {
        return INSTANCE;
    }
     ...
     * @param random
     */
    public static void manageVillagerTrades(MerchantRecipeList recipeList, EntityGreenVillager villager, int villagerType, Random random)
    {
    ...
    @SuppressWarnings("unchecked")
    public static void addEmeraldBuyRecipe(EntityGreenVillager villager, MerchantRecipeList list, Random random, Item item, float chance, int min, int max)
    {
        if (min > 0 && max > 0)
        {
            EntityGreenVillager.villagersSellingList.put(item, new Tuple(min, max));
        }
        EntityGreenVillager.func_146091_a(list, item, random, chance);
    }

    @SuppressWarnings("unchecked")
    public static void addEmeraldSellRecipe(EntityGreenVillager villager, MerchantRecipeList list, Random random, Item item, float chance, int min, int max)
    {
        if (min > 0 && max > 0)
        {
            EntityGreenVillager.blacksmithSellingList.put(item, new Tuple(min, max));
        }
        EntityGreenVillager.func_146089_b(list, item, random, chance);
    }

    public static void applyRandomTrade(EntityGreenVillager villager, Random rand)
    {
