...
public class EntityBeastBoy extends EntityMob
{
    ...
    public EntityBeastBoy(World par1World)
    {
        super(par1World);
        field_48119_b = 0;
        villageObj = null;
        ...
        if(mod_Rediscovered.BeastBoyHostile)
    ...
    public static class RenderMD3Steve extends RenderMD3{
        ...
        protected int getTextureIndex(Entity e){
            return ((EntityBeastBoy)e).type;
        }

        @Override
        protected float getSpeedMultiplier(Entity e){
            return ((EntityBeastBoy)e).animSpeed;
        }
    }
