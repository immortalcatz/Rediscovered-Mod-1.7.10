...
public class BlockEmptyRoseBushTop extends Block
{
    protected BlockEmptyRoseBushTop(Material p_i45395_1_)
    {
        super(p_i45395_1_);
    ...
    protected BlockEmptyRoseBushTop()
    {
    ...
    {
        return  p_149718_1_.getBlock(p_149718_2_, p_149718_3_ - 1, p_149718_4_) == mod_Rediscovered.EmptyRoseBush;
    }
