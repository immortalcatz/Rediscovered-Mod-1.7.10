...
{
  public final MD3Model load(String var1)
    throws IOException
  {
...
//        var11.e[var8] = nextVec3(vec3Pool, var1);
  ...
  private MD3Surface loadSurface(ByteBuffer var1) throws IOException
  {
    ...
    for (int i = 0; i < verts * frames; i++) {
      surface.vertices.put(var1.getShort() / 64.0F);
      surface.vertices.put(var1.getShort() / 64.0F);
      surface.vertices.put(var1.getShort() / 64.0F);
      double var15 = (var1.get() & 0xFF) * 3.141592653589793D * 2.0D / 255.0D;
      double var17 = (var1.get() & 0xFF) * 3.141592653589793D * 2.0D / 255.0D;
