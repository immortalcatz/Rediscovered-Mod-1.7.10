 ...
 * 
 */
public class RenderBlockLectern implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public RenderBlockLectern(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityLectern egg = new TileEntityLectern();
