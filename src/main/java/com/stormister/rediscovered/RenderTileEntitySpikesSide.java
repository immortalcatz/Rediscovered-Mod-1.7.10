...
public class RenderTileEntitySpikesSide extends TileEntitySpecialRenderer
{
	...
	public RenderTileEntitySpikesSide()
	{
		model = new ModelSpikesSide();
	}
	...
	private ModelSpikesSide model;
	
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8)
	{
		this.renderAModelAt((TileEntitySpikesSide)par1TileEntity, par2, par4, par6, par8);
	}
}