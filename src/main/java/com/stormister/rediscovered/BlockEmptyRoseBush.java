...
public class BlockEmptyRoseBush extends BlockBush
{
    ...
    {
    	p_149689_1_.setBlock(p_149689_2_, p_149689_3_+1, p_149689_4_, mod_Rediscovered.EmptyRoseBushTop);
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
        {
            ...
            if (p_149674_5_.nextInt((int)(25.0F / f) + 1) == 0)
            {
            	...
            	p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Blocks.double_plant, 4, 2);
            	p_149674_1_.setBlock(p_149674_2_, p_149674_3_+1, p_149674_4_, Blocks.double_plant, 8, 2);
            }
        }
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
        		this.field_149861_N[i] = p_149651_1_.registerIcon(mod_Rediscovered.modid + ":" + "empty_rose_bottom");
        }
    }
