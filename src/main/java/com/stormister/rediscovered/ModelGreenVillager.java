...
public class ModelGreenVillager extends ModelBase
{
    ...
    public ModelGreenVillager(float par1)
    {
        this(par1, 0.0F, 64, 64);
    }

    public ModelGreenVillager(float par1, float par2, int par3, int par4)
    {
