...
public class RenderBlockTable implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public RenderBlockTable(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityTable egg = new TileEntityTable();
