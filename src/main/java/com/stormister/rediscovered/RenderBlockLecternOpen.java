 ...
 * 
 */
public class RenderBlockLecternOpen implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public RenderBlockLecternOpen(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityLecternOpen egg = new TileEntityLecternOpen();
