 ...
 * 
 */
public class RenderBlockLockedChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public RenderBlockLockedChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityLockedChest egg = new TileEntityLockedChest();
