...
public class ItemDreamBed extends Item
{
    ...
    public ItemDreamBed(String texture)
    {
        super();
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            ++par5;
            BlockDreamBed blockbed = (BlockDreamBed)mod_Rediscovered.DreamBed;
            ...
            {
                if (par3World.isAirBlock(par4, par5, par6) && par3World.isAirBlock(par4 + b0, par5, par6 + b1) && par3World.doesBlockHaveSolidTopSurface(par3World, par4, par5 - 1, par6) && par3World.doesBlockHaveSolidTopSurface(par3World, par4 + b0, par5 - 1, par6 + b1))
                {
