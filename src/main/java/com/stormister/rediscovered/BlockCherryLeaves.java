...
public class BlockCherryLeaves extends BlockLeavesBase implements IShearable
{
	...
	public BlockCherryLeaves(LeafCategory cat)
	{
	...
	public void dropBlockAsItemWithChance(World world, int x, int y, int z, int metadata, float chance, int fortune)
	{
		...
		{
			this.dropBlockAsItem(world, x, y, z, new ItemStack(mod_Rediscovered.CherrySapling, 1));
		}

		if (((metadata & 3) == 0 || (metadata & 3) == 4 || (metadata & 3) == 7) && (world.rand.nextInt(50) == 0)) 
		{
			this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.apple, 1, 8));
		}
	}
