...
public class ModelSkeletonHorse extends ModelBase
{
    ...
    {
        EntitySkeletonHorse entityhorse = (EntitySkeletonHorse)par1Entity;
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        ...
        EntitySkeletonHorse entityhorse = (EntitySkeletonHorse)par1EntityLivingBase;
